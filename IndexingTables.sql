...
GO	-- SCAN TABLES Custmer List with Statistics IO
...
-- SEEK PREDICATE with Statistics IO
SELECT * FROM Orders.CustomerList -- view
where Customer_ID = 3

GO


-- DEMO EFFECT OF DIFFERENTS CLUSTERED INDEXES
-- Create view Customer List
CREATE OR ALTER VIEW Orders.CustomerList
WITH SCHEMABINDING
AS
SELECT 
